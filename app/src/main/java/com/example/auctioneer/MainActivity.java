...
public class MainActivity extends AppCompatActivity {
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            startAuctionMapActivityforgoog();
                        } else {
                            // Sign-in failed
                            Toast.makeText(getApplicationContext(), "Sign-In failed. Please sign in with a different method or try again later", Toast.LENGTH_LONG).show();
                        }
                    }
                });
    }
    ...
    private void startAuctionMapActivity() {
        Intent intent = new Intent(MainActivity.this,registeringpage.class);
        startActivity(intent);
        finish();
    }
    private void startAuctionMapActivityforgoog() {
